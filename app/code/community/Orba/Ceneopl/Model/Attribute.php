<?php
class Orba_Ceneopl_Model_Attribute extends Mage_Core_Model_Abstract {
    
    protected function _construct() {
        $this->_init('ceneopl/attribute');
    } 
    ...
    public function createAttribute($code, $label, $attribute_type, $product_type, $attribute_data, $attribute_set_name, $group_name, $entity_type_id = 'catalog_product') {
        ...
        try {
            ...
            Mage::log("Couldn't create attribute $code. Exception: ".$e->getMessage(), null, 'ceneopl.log');
        }
    } 
